...
const Carousel = () => {
  ...
  return (
    <>
    <h1 style={{ textAlign: "center", fontFamily: "montserat_bold", fontSize: "2.3rem"}}>Что умеют наши пользователи!</h1>
     ...
     <div className="newsCards">
      ...
      <div className="course-announcement">
        <div className="course-text">
          <p>👋 <strong>Новые курсы уже на SkillSphere! Пришло время учиться чему-то новому!</strong></p>
          <p>Мы рады сообщить, что раздел Курсы пополнился свежими и увлекательными программами для саморазвития! Например:</p>
          <ul>
            <li>Изучайте основы программирования с нашими интерактивными уроками.</li>
            <li>Погружайтесь в мир дизайна и создавайте свои первые проекты.</li>
            <li>Осваивайте полезные инструменты для личной продуктивности.</li>
          </ul>
          <p>Все курсы доступны бесплатно, и начать можно прямо сейчас — без подготовки. Просто выберите то, что вам интересно, и погрузитесь в увлекательный процесс обучения!</p>
          <p><strong>Не упустите шанс расширить свои знания — перейдите в раздел Курсы и выберите свой путь к новым навыкам! 🚀</strong></p>
        </div>
